...
public protocol AnyFlutterStandardCodable {
...
public extension AnyFlutterStandardCodable {
    init(_ any: Any) throws {
        ...
        } else if let any = any as? AnyFlutterStandardCodable {
...
extension Int8: AnyFlutterStandardCodable {
...
extension Int16: AnyFlutterStandardCodable {
    public init(any: AnyFlutterStandardCodable) throws {
        guard case let .int32(int32) = any else {
            throw FlutterSwiftError.fieldNotDecodable
        }
...
extension UInt8: AnyFlutterStandardCodable {
    public init(any: AnyFlutterStandardCodable) throws {
        guard case let .int32(int32) = any else {
            throw FlutterSwiftError.fieldNotDecodable
        }
...
extension UInt16: AnyFlutterStandardCodable {
    public init(any: AnyFlutterStandardCodable) throws {
        guard case let .int32(int32) = any else {
            throw FlutterSwiftError.fieldNotDecodable
        }
...
extension UInt32: AnyFlutterStandardCodable {
    public init(any: AnyFlutterStandardCodable) throws {
...
extension Float: AnyFlutterStandardCodable {
    public init(any: AnyFlutterStandardCodable) throws {
...
extension Data: AnyFlutterStandardCodable {
    public init(any: AnyFlutterStandardCodable) throws {
...
public extension AnyFlutterStandardCodable {
    func value(as type: Any.Type? = nil) throws -> Any {
        if let type = type as? AnyFlutterStandardCodable.Type {
            do {
